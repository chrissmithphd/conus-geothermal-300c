...
# geothermal_metrics_by_depth.png is now generated by create_combined_metrics_plot.py
...
def main():
    ...
    print("Done")
    print("\nNote: For geothermal_metrics_by_depth.png, run: python create_combined_metrics_plot.py")
