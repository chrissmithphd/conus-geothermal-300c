...
# Area + capacity read from the energy analysis output (single source of truth,
...
AREA_KM2 = [int(_energy.loc[b, "area_km2"]) if b in _energy.index else 0 for b in BINS]
CAPACITY_GW = [round(_energy.loc[b, "capacity_typical_mw"] / 1000, 1) if b in _energy.index else 0 for b in BINS]
